    ...
    <nav class="navbar navbar-expand-lg navbar bg-primary" data-bs-theme="dark">
        ...
        <main class="flex-fill">
            <div class="container">
              ...
              <form class=" mt-3 " method="POST" action="teste.php">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" name="observação">
                                  </div>
                                  <div class="mb-3">
